...
```json
{
  "applicationName" : "sample-weather",
...
┃ ┃ ┃ Debug Adding symbol compilerSafeAppName with value 'sample_weather'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->sample-weather]
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].sources[0].delegate.transformations[3] (RewritePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Path 'Sample.csproj' matched 'Sample(.*)' with groups {g0=Sample.csproj, g1=.csproj} and was rewritten to 'sample-weather.csproj'
┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.sln' matched 'Sample(.*)' with groups {g0=Sample.sln, g1=.sln} and was rewritten to 'sample-weather.sln'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->sample-weather, sample-app->weatherforecast-stee...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->sample_weather]
